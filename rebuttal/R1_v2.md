...
The table below summarizes the quantitative comparison of G-Loss-O and SCL (closest competitor) across five benchmark datasets in terms of both representation quality and training efficiency:
...
5. Hyperparameter complexity and sensitivity
