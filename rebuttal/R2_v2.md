...
These results indicate that G-Loss continues to improve performance even on larger and more complex datasets. We are currently running experiments on QNLI with all three model variants (BERT-base, **DistilBERT**, and RoBERTa-large) and will include these results in the camera-ready version.
