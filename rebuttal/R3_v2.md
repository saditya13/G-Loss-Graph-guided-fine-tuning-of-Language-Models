...
We have added a systematic guide in Appendix Section G, which includes a complete list of hyperparameters, their roles, and empirically determined stable ranges (γ: 0.5–0.7, λ: 0.7–0.9, σ within ±0.5× of the optimal value). This guide simplifies tuning and improves reproducibility across datasets. We are also exploring adaptive tuning strategies for σ and γ as part of ongoing work.
