...
References
[1] Zhu, X., Ghahramani, Z., & Lafferty, J. D. (2003). *Semi-supervised learning using Gaussian fields and harmonic functions*. ICML.
[2] Zhou, D., Bousquet, O., Lal, T. N., Weston, J., & Schölkopf, B. (2003). *Learning with local and global consistency*. NIPS.
